(function(){
	...
	function isPrimitiveValue(x){
		...
		var xType = (x === null) ? "null" : typeof x;
		if(xType !== "Object"){
			return true;
		}
		return false;
	...
	*/	
	function ToPrimitive(input, PreferredType){	
		var inputType = (input === null)? "null" : typeof input;
	...
	*/
	function SameValue(x,y){
		//We first get the type: we need to check if it's null, because
		//typeof null returns "object"
		var xType = (x === null)? "null" : typeof x; 
		var yType = (y === null)? "null" : typeof x; 
