...
@param exports Object to which WebIDL will be bound.
@param ECMAScript  An implementation of the abstract algorithms of ECMAScript.
@param WebIDLParser A WebIDL parser.
*/
(function(exports, ECMAScript, WebIDLParser) {
    'use strict';
    var WebIDLEnv = this,
        exceptionPrototypes = {},
        interfaceBuilder = new InterfaceBuilder(exports),
        exceptionBuilder = new ExceptionBuilder(exports),
    ...
    function initialize(self) {
        ...
        */
        ...
        props = ECMAScript.createAccessorProperty(getClass);
        Object.defineProperty(P, '__class__', props);
        props = ECMAScript.createAccessorProperty(getToString);
			...
			*/
            function operationToString(member, interfacePrototypeObject) {
                ...
                if (!ECMAScript.IsCallable(F)) {
                    throw new TypeError('Uncallable');
                }
            ...
            function addConst(obj, name, value, type, extAttrs) {
                ...
                */
                ...
                switch (type) {
                    //primitive types
                    case 'unsigned short':
                            result = toUnsignedShort(value, extAttrs);
                            break;
                    case 'boolean':
                    case 'float':
    ...
    */
    ...
    function isPlatformObj(O) {
        ...
        var globalInstance = exports[oClass];
    ...
    function convertToUnicode(S) {
        ...
        while (i < n) {
            ...
            c = Number('0x' + S[i].charCodeAt().toString(16));
            ...
            if (c < 0xD800 || c > 0xDFFF) {
                ...
                if (i === n - 1) {
                    ...
                    d = Number('0x' + S[i + 1].charCodeAt().toString(16));
                    ...
                    if (0xDC00 <= d <= 0xDFFF) {
                        ...
                        U.push(Math.pow(2, 16) + Math.pow(2, 10) + a + b);
                        //Set i to i+1.
                        i = i + 1;
    ...
    */
    ...
    WebIDL.Short.prototype = new IDLType('Short');
    /*
    ...
    */
    WebIDL.UnsignedLong = function(value) {};
    WebIDL.UnsignedLong.prototype = new IDLType('UnsignedLong');
    /*
        3.10.9. long long
    ...
    */
    ...
    WebIDL.DOMString.prototype = new IDLType('String');
    /*
    3.10.16. object
    ...
    */
    ...
    WebIDL.Object.prototype = new IDLType('Object');
    /*
     3.10.25. Date
    ...
    */
    ...
    WebIDL.Date.prototype = new IDLType('Date');
